...
// projects section
$("#nav-projects").bind('touch mouseup', function(){
  if (!flag) {
    flag = true;
    setTimeout(function(){ flag = false; }, 200);
    scrollTo("#projects-section",850)
  }
  return false
});
// experience section
...
// projects section
$("#nav-projects-2").bind('touch mouseup', function(){
  if (!flag) {
    flag = true;
    setTimeout(function(){ flag = false; }, 200);
    scrollTo("#projects-section",550)
  }
  return false
});
// contact section
...
// force hover event on mobile for projects
var flag2 = false;
